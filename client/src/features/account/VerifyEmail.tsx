    ...
    const getBody = () => {
        switch (status) {
            ...
            case 'failed':
                return (
                    <Box display="flex" flexDirection="column" gap={2}>
                        <Typography>Verification failed. You can try resending the verify link to your
                            email.</Typography>
                        <Button onClick={() => resendConfirmationEmail.mutate({ userId })}
            ...
            case 'verified':
                return (
                    <Box display="flex" flexDirection="column" gap={2}>
                        <Typography>You email has been verified. You can now login.</Typography>
