    ...
    : BaseApiController
{
    ...
    public async Task<ActionResult> LoginWithGitHub(string code)
    {
        ...
        if (user == null) return BadRequest("Failed to read user");

        // step 3 - get email is needed
    ...
    public async Task<ActionResult> ChangePassword(ChangePasswordDto passwordDto)
    {
        ...
        var result =
            await signInManager.UserManager.ChangePasswordAsync(user, passwordDto.CurrentPassword,
